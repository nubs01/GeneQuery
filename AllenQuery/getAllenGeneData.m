...
usdDat = struct('gene',repmat({geneName},1,numel(sdsDat)),'id',...
    {sdsDat.id},'expression_energy',[],'zEE',[],'section_plane','',...
    'strctures_of_interest',repmat({StructuresOfInterest},1,numel(sdsDat)),...
    'section_plane_id',[],'USD_file',[],'plot_file',[]);
for i=1:numel(sdsDat),
    ...
    usdDat(i).section_plane_id = USD.plane_of_section_id;
end
